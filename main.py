    ...
    try:
        ...
        try:
            ...
            pg_connection.execute(text("""
                CREATE TABLE IF NOT EXISTS _customer_transactions (
            ...
            pg_connection.execute(text('TRUNCATE TABLE _customer_transactions'))
            ...
            insert_stmt = text(f"""
                INSERT INTO _customer_transactions ({cols_quoted})
                VALUES ({params})
            """)
...
dag = DAG(
    'etl__customer_transactions',
    default_args=default_args,
    description='Daily ETL from Oracle to PostgreSQL for _CUSTOMER_TRANSACTIONS',
